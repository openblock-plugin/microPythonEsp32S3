export default Blockly => {
    ...
    Blockly.Python.microPython_pin_readTouchPin = function (block) {
        const pin = block.getFieldValue('PIN');
    ...
    Blockly.Python.microPython_pin_esp32S3ReadTouchPin = Blockly.Python.microPython_pin_readTouchPin;
