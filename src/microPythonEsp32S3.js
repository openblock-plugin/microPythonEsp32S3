...
const DIVECE_OPT = {
    ...
    firmware: 'microPython-esp32S3.bin',
    dtr: false,
    rts: false
};
                ...
                blocks: [
                    {
                        opcode: 'setPinMode',
                        text: formatMessage({
                            id: 'microPythonEsp32S3.pins.esp32SetPinMode',
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            id: 'microPythonEsp32S3.pins.esp32SetDigitalOutput',
                    ...
                    },
                    {
                        opcode: 'setPwmOutput',
                        text: formatMessage({
                            id: 'microPythonEsp32S3.pins.esp32SetPwmOutput',
                    ...
                    '---',
                    {
                        ...
                        text: formatMessage({
                            id: 'microPythonEsp32S3.pins.esp32ReadDigitalPin',
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            id: 'microPythonEsp32S3.pins.esp32ReadAnalogPin',
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            id: 'microPythonEsp32S3.pins.esp32ReadTouchPin',
                    ...
                    '---',
                    {
                        ...
                        text: formatMessage({
                            id: 'microPythonEsp32S3.pins.esp32AttachInterrupt',
